...
import { MigrationAssetsSchema, MigrationItemsSchema } from "../core/models/migration.schema.js";
import { findRequired } from "../core/utils/array.utils.js";
import { getBinaryDataFromUrlAsync } from "../core/utils/binary-data.utils.js";
	...
	const mapToMigrationComponent = (
		...
		if (!componentType) {
			throw new MigrationToolkitError(
				"missingContentType",
				`Could not find content type with id '${chalk.red(component.type.id)}' for component '${chalk.red(component.id)}'`,
			);
		}
